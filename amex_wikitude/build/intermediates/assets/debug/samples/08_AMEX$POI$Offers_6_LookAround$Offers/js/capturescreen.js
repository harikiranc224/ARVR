...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		World.markerDrawable_idle = new AR.ImageResource("assets/gps.png");
		World.markerDrawable_selected = new AR.ImageResource("assets/gps.png");
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
            ...
            if(currentPlaceNr == 0){
              poiData[currentPlaceNr].id = '0000';
              poiData[currentPlaceNr].name = 'WALMART';
              poiData[currentPlaceNr].description='$ 5% Discount on your AXP Gold card';
            }else if(currentPlaceNr == 1){

                 poiData[currentPlaceNr].id = '1000';
                 poiData[currentPlaceNr].name = 'BESTBUY';
                 poiData[currentPlaceNr].description='40% !if you use your Membership Rewards points for your purchase with your AXP Gold card in BESTBUY,they will be worth twice as much (50% off)';


            }else if(currentPlaceNr == 2){
                 poiData[currentPlaceNr].id = '2000';
                 poiData[currentPlaceNr].name = 'TARGET';
                 poiData[currentPlaceNr].description='$ 5% Discount on your AXP Gold card';


            }else if(currentPlaceNr == 3){

                 poiData[currentPlaceNr].id = '3000';
                 poiData[currentPlaceNr].name = 'STARBUCKS';
                 poiData[currentPlaceNr].description='50% off ! if you use your Membership Rewards points for your purchase with your AXP Gold card in RiteAid,they will be worth twice as much (50% off)';

            }else if(currentPlaceNr == 4){
                poiData[currentPlaceNr].id = '4000';
                poiData[currentPlaceNr].name = 'TOYSRUS';
                poiData[currentPlaceNr].description='10% offers on your Card';
            }
             else if(currentPlaceNr == 5){
                 poiData[currentPlaceNr].id = '5000';
                 poiData[currentPlaceNr].name = 'McDonalds';
                 poiData[currentPlaceNr].description='10% off ! if you use your Membership Rewards points for your purchase with your AXP Gold card in McDonalds,they will be worth twice as much (10% off)';
             }else if(currentPlaceNr == 6){ 
             poiData[currentPlaceNr].id = '6000'; 
             poiData[currentPlaceNr].name = 'RiteAid'; 
             poiData[currentPlaceNr].description='40% off ! if you use your Membership Rewards points for your purchase with your AXP Gold card in RiteAid,they will be worth twice as much (40% off)';
              }
