...
public class FaceDetectionPluginActivity extends SampleCamActivity {
    ...
    private String TAG = "FaceDetectionPluginActivity";

    @Override
    protected void onPostCreate(final Bundle savedInstanceState) {
        super.onPostCreate(savedInstanceState);
        this.architectView.registerNativePlugins("wikitudePlugins", "face_detection", new PluginManager.PluginErrorCallback() {
            @Override
